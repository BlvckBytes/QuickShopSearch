...
public enum PluginPermission {
  ...
  FEATURE_TELEPORT_CLOSEST_PLAYER_WARP("feature.teleport.closest-player-warp"),
  FEATURE_TELEPORT_CLOSEST_PLAYER_WARP_BAN_BYPASS("feature.teleport.closest-player-warp.ban-bypass"),
