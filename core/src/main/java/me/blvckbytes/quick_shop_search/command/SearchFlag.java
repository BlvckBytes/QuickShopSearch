...
public abstract class SearchFlag<T> implements MatchableEnum {
  ...
  public static final SearchFlag<OfflinePlayer> OWNER = new SearchFlag<>("OWNER") {
  ...
  public static final SearchFlag<Integer> RADIUS = new SearchFlag<>("RADIUS") {
  ...
  public static final SearchFlag<Double> PRICE = new SearchFlag<>("PRICE") {
    ...
    public boolean _test(CachedShop shop, Player executor, @NotNull Double value) {
      return shop.handle.getPrice() - value < .001;
    }
  };

  public static final SearchFlag<Double> MAX_PRICE = new SearchFlag<>("MAX_PRICE") {
  ...
  public static final SearchFlag<Double> MIN_PRICE = new SearchFlag<>("MIN_PRICE") {
  ...
  private SearchFlag(String name) {
    this.name = name;
